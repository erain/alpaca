...
public class BlockingWriteLock {
	...
	private CountDownLatch _lockAquiredSignal = new CountDownLatch(1);
	...
	public boolean lock(long timeout, TimeUnit unit)
		...
		_writeLock.lock();
		return _lockAquiredSignal.await(timeout, unit);
	}
	...
	class SyncLockListener implements LockListener {
		...
		public void lockAcquired() {
			System.out.printf("Lock aquired by %s on %s\n", _name, _path);
			_lockAquiredSignal.countDown();
		}
